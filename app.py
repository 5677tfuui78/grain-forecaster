...
# --- PAGE SETUP ---
st.set_page_config(page_title="Grain Forecaster", layout="wide", page_icon="🌾")
st.title("🌾 Grain Price Forecaster")
...
for i, (name, info) in enumerate(COMMODITIES.items()):
    with tabs[i]:
        ...
        if df is not None:
            ...
            trend = "🐂 Bullish" if forecast_6mo > current_mt else "🐻 Bearish"
